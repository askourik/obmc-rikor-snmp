...
#include "rikor/powerstate.hpp"
#include "rikor/sensors.hpp"
#include "rikor/software.hpp"
#include "rikor/inventory.hpp"
...
int main(int argc, char* argv[])
{
    ...
    rikor::host::power::state::init();
    rikor::sensors::init();
    rikor::software::init();
    rikor::inventory::init();
    ...
    rikor::inventory::destroy();
    rikor::software::destroy();
    rikor::sensors::destroy();
    rikor::host::power::state::destroy();
